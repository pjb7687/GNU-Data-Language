/*	$Id: gshhs.h,v 1.3 2014/09/19 15:43:59 gilles-duvert Exp $
 *
...
/*
 * Modified by GDL team (renamed POINT to GSHHS_POINT to avoid conflict with a POINT structure present in Windows API (?)
 * Certainly there is a better way to handle this problem, but we are a bit at loss here...
 */
